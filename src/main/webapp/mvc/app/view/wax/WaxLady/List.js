Ext.define('mvc.view.wax.WaxLady.List',{
...
var mainActs = [];		this.items =[{
		...
		items : [{
				...
				items : [{
						...
						items : [{xtype : 'textfield',name : 'bean.name',fieldLabel : '姓名'}
							,{xtype : 'textfield',name : 'bean.mobile',fieldLabel : '手机'}
							]
					}]
			}]
	},{
		...
		items : [{
				xtype : Ext.create('mvc.view.wax.WaxLady.ListMain',{
							title : '享女郎',
							...
							listeners : 							 {
				                ...
				                selectionchange: function(model, records) {
				                    if (records.length === 1){
        								...
        								this.mdLineTable.store.filter([{'id':'filter', 'property':'lady','value':records[0].get('bean.pkey')}]);
				...
				xtype : Ext.create('mvc.view.wax.WaxLady.ListLineWaxLadyPic',{
							title : '图片',
...
onSearchAdv : function(){
		var win = Ext.create('mvc.view.wax.WaxLady.WinSearch',{
