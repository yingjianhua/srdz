Ext.define('mvc.view.wax.WaxBnftEntry.TriggerList',{
...
this.columns = [{text : '福利活动',width : 100,dataIndex : 'bean.bnft',sortable : true,renderer : mvc.Tools.beanRenderer()}
	...
	,{text : '截图',width : 100,dataIndex : 'bean.imgUrl',sortable : true}
	...
	,{text : '公众帐号',width : 100,dataIndex : 'bean.account',sortable : true,renderer : mvc.Tools.beanRenderer()}
		...
		this.store=Ext.create('mvc.store.wax.WaxBnftEntry');this.dockedItems = [{
		dock : 'top',
		xtype : 'toolbar',
		items : ["搜索：",{
				xtype : 'combo',
