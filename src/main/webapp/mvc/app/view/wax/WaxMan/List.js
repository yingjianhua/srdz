Ext.define('mvc.view.wax.WaxMan.List',{
...
var mainActs = [];		this.items =[{
		...
		items : [{
				xtype : Ext.create('mvc.view.wax.WaxMan.ListMain',{
							title : '男人帮',
							...
							listeners : 							 {
				                ...
				                selectionchange: function(model, records) {
				                    if (records.length === 1){
        								...
        								this.mdLineTable.store.filter([{'id':'filter', 'property':'man','value':records[0].get('bean.pkey')}]);
				...
				xtype : Ext.create('mvc.view.wax.WaxMan.ListLineWaxManPic',{
							title : '图片',
...
onSearchAdv : function(){
		var win = Ext.create('mvc.view.wax.WaxMan.WinSearch',{
