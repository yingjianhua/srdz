Ext.define('mvc.view.wx.WxExpand.TriggerList',{
...
this.columns = [{text : '功能类',width : 100,dataIndex : 'bean.action',sortable : true}
	...
	,{text : '封面',width : 100,dataIndex : 'bean.imageUrl',sortable : true}
	];
		this.store=Ext.create('mvc.store.wx.WxExpand');this.dockedItems = [{
		dock : 'top',
		xtype : 'toolbar',
		items : ["搜索：",{
				xtype : 'combo',
