Ext.define('mvc.view.wx.WxExpand.List',{
...
onUpdateRecord : function(form, data){
		...
		var bean = Ext.create('mvc.model.wx.WxExpand', data);
...
onUpdWin : function(selection){
		if (selection){
			var win = Ext.create('mvc.view.wx.WxExpand.Win',{
				title : this.title+'>修改',
				insFlag : false
			});
...
onSearchAdv : function(){
		var win = Ext.create('mvc.view.wx.WxExpand.WinSearch',{
