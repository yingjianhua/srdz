Ext.define('mvc.view.wpt.WptSpecial.Win',{
...
initComponent : function(){
		...
		anchor : '100%',
		plain : true,
		xtype : Ext.create('mvc.view.wpt.WptSpecial.Form',{	insFlag : this.insFlag})
	},{
		xtype : Ext.create('mvc.view.wpt.WptSpecial.ListForm',{height : 300,border : false })
	}];
