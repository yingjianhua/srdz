Ext.define('mvc.view.wpt.WptSpecial.List',{
extend : 'Ext.panel.Panel',
oldId : 'WptSpecial_list_',
loadMask : true,
multiSelect : true,
roles : '',
layout : 'border',
...
mainActs.push({
		...
		items : [{
				xtype : Ext.create('mvc.view.wpt.WptSpecial.ListMain',{
							title : '专题',
				...
				xtype : Ext.create('mvc.view.wpt.WptSpecial.ListLineWptSpecialLine',{
							title : '餐厅',
...
onSearchAdv : function(){
		var win = Ext.create('mvc.view.wpt.WptSpecial.WinSearch',{
