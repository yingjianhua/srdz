Ext.define('mvc.view.wpt.WptRestaurantBanner.List',{
extend : 'Ext.grid.Panel',
oldId : 'btn_WptRestaurantBanner',
lock : true,
...
onIns : function(){
		var win = Ext.create('mvc.view.wpt.WptRestaurantBanner.Win',{
			title : this.title+'>新增'
		});
...
onUpdateRecord : function(form, data){
		...
		var bean = Ext.create('mvc.model.wpt.WptRestaurantBanner', data);
		...
		if (selection){
			...
			Ext.MessageBox.confirm(msg_confirm_title, msg_confirm_msg, 
				function(btn) {
					...
					Ext.Ajax.request({
						url : base_path+'/wpt_WptRestaurantBanner_delMulti?pkeys='+arr.toString()+'&rowVersions='+arrv.toString(),
...
onSearchAdv : function(){
		var win = Ext.create('mvc.view.wpt.WptRestaurantBanner.WinSearch',{
