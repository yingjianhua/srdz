Ext.define('mvc.view.wpt.WptHot.List',{
...
this.columns = [{text : '城市',width : 100,dataIndex : 'city.pkey',sortable : true,renderer : mvc.Tools.beanRendererHref(),md : 'wpt',mn : 'view.wpt.WptCity.List'}
	...
	,{text : '排序',width : 100,dataIndex : 'sort',sortable : true}
		...
		if (mainActs.length > 0)
			this.tbar=mainActs;
		this.store=Ext.create('mvc.store.wpt.WptHot'); 
...
onIns : function(){
		var win = Ext.create('mvc.view.wpt.WptHot.Win',{
			title : this.title+'>新增'
		});
...
onSearchAdv : function(){
		var win = Ext.create('mvc.view.wpt.WptHot.WinSearch',{
