Ext.define('mvc.view.wpt.WptRestaurantTemplate.List',{
extend : 'Ext.grid.Panel',
oldId : 'btn_WptRestaurantTemplate',
lock : true,
...
onIns : function(){
		var win = Ext.create('mvc.view.wpt.WptRestaurantTemplate.Win',{
			title : this.title+'>新增'
		});
...
onUpdateRecord : function(form, data){
		...
		var bean = Ext.create('mvc.model.wpt.WptRestaurantTemplate', data);
		...
		if (selection){
			...
			Ext.MessageBox.confirm(msg_confirm_title, msg_confirm_msg, 
				function(btn) {
					...
					Ext.Ajax.request({
						url : base_path+'/wpt_WptRestaurantTemplate_delMulti?pkeys='+arr.toString()+'&rowVersions='+arrv.toString(),
...
onSearchAdv : function(){
		var win = Ext.create('mvc.view.wpt.WptRestaurantTemplate.WinSearch',{
