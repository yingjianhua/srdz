Ext.define('mvc.view.wpt.WptOrder.Win',{
...
initComponent : function(){
		...
		anchor : '100%',
		plain : true,
		xtype : Ext.create('mvc.view.wpt.WptOrder.Form',{	isPt : this.isPt})
	},{
		xtype : Ext.create('mvc.view.wpt.WptOrder.ListForm',{height : 300,border : false })
	}];
