Ext.define('mvc.view.wpt.WptRestaurantCase.List',{
extend : 'Ext.grid.Panel',
oldId : 'btn_WptRestaurantCase',
lock : true,
...
onIns : function(){
		var win = Ext.create('mvc.view.wpt.WptRestaurantCase.Win',{
			title : this.title+'>新增'
		});
...
onUpdateRecord : function(form, data){
		...
		var bean = Ext.create('mvc.model.wpt.WptRestaurantCase', data);
...
onSearchAdv : function(){
		var win = Ext.create('mvc.view.wpt.WptRestaurantCase.WinSearch',{
