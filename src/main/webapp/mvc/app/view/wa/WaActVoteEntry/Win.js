Ext.define('mvc.view.wa.WaActVoteEntry.Win',{
...
initComponent : function(){
		...
		anchor : '100%',
		plain : true,
		xtype : Ext.create('mvc.view.wa.WaActVoteEntry.Form',{	insFlag : this.insFlag})
	},{
		xtype : Ext.create('mvc.view.wa.WaActVoteEntry.ListForm',{height : 300,border : false })
	}];
...
setActiveRecord : function(record){
		...
		if (record || this.form.activeRecord) {
			...
			this.lineTable.store.filter([{'id':'filter','property':'voteEntry','value':record.get('bean.pkey')}]);
		} else {
