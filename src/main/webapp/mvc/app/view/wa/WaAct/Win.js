Ext.define('mvc.view.wa.WaAct.Win',{
...
initComponent : function(){
		...
		anchor : '100%',
		plain : true,
		xtype : Ext.create('mvc.view.wa.WaAct.Form',{	insFlag : this.insFlag})
	},{
		xtype : Ext.create('mvc.view.wa.WaAct.ListForm',{height : 150,border : false })
	}];
