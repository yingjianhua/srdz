Ext.define('mvc.view.wa.WaActVote.Win',{
...
initComponent : function(){
		...
		anchor : '100%',
		plain : true,
		xtype : Ext.create('mvc.view.wa.WaActVote.Form',{	insFlag : this.insFlag})
	},{
		xtype : Ext.create('mvc.view.wa.WaActVote.ListForm',{height : 150,border : false })
	}];
...
setActiveRecord : function(record){
		...
		if (record || this.form.activeRecord) {
			...
			this.lineTable.store.filter([{'id':'filter','property':'vote','value':record.get('bean.pkey')}]);
		} else {
