Ext.define('mvc.view.wa.WaActTemplate.Win',{
...
initComponent : function(){
		...
		anchor : '100%',
		plain : true,
		xtype : Ext.create('mvc.view.wa.WaActTemplate.Form',{	insFlag : this.insFlag})
	},{
		xtype : Ext.create('mvc.view.wa.WaActTemplate.ListForm',{height : 300,border : false })
	}];
