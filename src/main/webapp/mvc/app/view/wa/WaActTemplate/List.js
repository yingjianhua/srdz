Ext.define('mvc.view.wa.WaActTemplate.List',{
extend : 'Ext.panel.Panel',
oldId : 'WaActTemplate_list_',
loadMask : true,
multiSelect : true,
roles : '',
layout : 'border',
...
mainActs.push({
		...
		items : [{
				xtype : Ext.create('mvc.view.wa.WaActTemplate.ListMain',{
							title : '页面模板',
				...
				xtype : Ext.create('mvc.view.wa.WaActTemplate.ListLineWaActTemplateLine',{
							title : '页面配置',
...
onIns : function(){
		var win = Ext.create('mvc.view.wa.WaActTemplate.Win',{
			title : this.title+'>新增'
		});
		...
		if (selection){
			...
			Ext.MessageBox.confirm(msg_confirm_title, msg_confirm_msg, 
				function(btn) {
					...
					Ext.Ajax.request({
						url : base_path+'/wa_WaActTemplate_delMulti?pkeys='+arr.toString()+'&rowVersions='+arrv.toString(),
...
onSearchAdv : function(){
		var win = Ext.create('mvc.view.wa.WaActTemplate.WinSearch',{
