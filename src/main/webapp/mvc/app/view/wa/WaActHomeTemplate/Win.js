Ext.define('mvc.view.wa.WaActHomeTemplate.Win',{
...
initComponent : function(){
		...
		anchor : '100%',
		plain : true,
		xtype : Ext.create('mvc.view.wa.WaActHomeTemplate.Form',{	insFlag : this.insFlag})
	},{
		xtype : Ext.create('mvc.view.wa.WaActHomeTemplate.ListForm',{height : 300,border : false })
	}];
...
setActiveRecord : function(record){
		...
		if (record || this.form.activeRecord) {
			...
			this.lineTable.store.filter([{'id':'filter','property':'homeTemp','value':record.get('bean.pkey')}]);
		} else {
