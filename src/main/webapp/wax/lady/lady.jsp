...
<body>
	...
	<div class="banner">
		<img src="wax/lady/assets/img/banner.jpg">
	</div>
	...
	<div class="hdjs">
			...
			<form  id="imgForm" action="expand_wax_WaxLady_xcute" method="post" enctype="multipart/form-data">
				<div class="hdjs-form">
					...
					<div class="hdjs-form-tr clearfix">
						...
						<div class="hdjs-form-img1">
							<ul id="imgUL" class="wxhd_sign_img_list clearfix">
								<li id="choseLI"><img id="chooseImage"  src="wax/lady/assets/img/wxhd_img_add.png"></li>							
							</ul>
						</div>
					</div>
