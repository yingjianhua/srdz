...
<body class="gray-bg">	
	...
	<div class="hait_list">
		...
		<a href="javascript:;" class="hait_li" pkey="<s:property value="#combo.pkey"/>" style="height:395px">
			<img src="../<s:property value="#combo.imgUrl" />" class="photo" style="height:284px"/>
			<dl>
