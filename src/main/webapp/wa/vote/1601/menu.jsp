...
<%@ taglib prefix="s" uri="/struts-tags"%>
	...
	<div id="layer_qrcode">
		<div class="layer_qrcode_cont">
			<div id="layer_qrcode_close"><img src="wa/vote/1601/assets/img/layer_close.png"></div>
			<p class="layer_qrcode_tt">长按下方图片,识别二维码　<br>
进入公众号，点击下方菜单栏进行报名或投票。</p>
			<div id="layer_qrcode_img"><img src="wa/vote/1601/assets/img/qrcode/${account.pkey }.jpg"></div>
		</div>
	</div>
...
<script src="wa/vote/1601/assets/js/libs/TouchSlide.1.1.js"></script>
<script>
$(function(){
	var _errMsg = '${errMsg}';
	if(_errMsg != '') {
