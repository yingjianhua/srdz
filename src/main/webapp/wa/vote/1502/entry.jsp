...
<script type="text/javascript">
	...
	function imgForm_submit() {
		...
		if($("[name='bean.des']:first").val() === "") {
			showMessage("参赛宣言不能为空");
			return false;
		}
		if($("[name='bean.des']:first").val().length > 45) {
			showMessage("参赛宣言过长");
			return false;
		}
			...
			<p class="wxhd_news_title1">活动报名</p>
				...
				<div class="wxhd_form_td clearfix">
					...
					<div class="wxhd_form_input">
						<input type="text" name="bean.namePerson" value="${voteEntry.namePerson}"/>
					</div>
				</div>
				<div class="wxhd_form_td clearfix">
					<div class="wxhd_form_tt">电话：</div>
					<div class="wxhd_form_input">
						<input type="text" name="bean.phonePerson" value="${voteEntry.phonePerson}"/>
					</div>
				</div>
				<div class="wxhd_form_td clearfix">
					<div class="wxhd_form_tt">参赛　<br>宣言：</div>
					<div class="wxhd_form_input">
						<textarea rows="5" name="bean.des">${voteEntry.des}</textarea>
					</div>
				</div>
				<div class="wxhd_form_td clearfix">
					...
					<div class="wxhd_form_input">
						...
						<li id="choseLI">
							<img id="chooseImage" src="wa/vote/1501/assets/img/wxhd_img_add.png">
						</li>
						</ul>
					</div>
				</div>
				...
				<div class="wxhd_form_td wxhd_sign_tt clearfix">
					（若在线报名失败，可以将报名信息：姓名+联系方式+描述 +照片 发到邮箱：huyuanyuan@lexiangapp.cn）
				</div>
			</form>
		</div>
	</section>
<script src="wa/vote/1502/assets/js/functions.js"></script>
<script>
$(function(){
