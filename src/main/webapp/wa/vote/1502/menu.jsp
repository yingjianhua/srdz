...
<%@ taglib prefix="s" uri="/struts-tags"%>
	...
	<div id="float_nav">
		...
		<s:else>
			<a href="expand_wa_WaActVote_showCustom?pkey=${vote.pkey}" id="float_nav4" <s:if test="%{currPage.line.key == 99}">class="curr"</s:if>> 杭州美食酱 </a>
		</s:else>
		</li>
		</ul>
	</div>
	...
	<div id="layer_qrcode">
		<div class="layer_qrcode_cont">
			<div id="layer_qrcode_close"><img src="wa/vote/1502/assets/img/layer_close.png"></div>
			<p class="layer_qrcode_tt">长按下方图片点击识别二维码　<br>
进入公众号，点击下方菜单栏进行报名或投票。</p>
			<div id="layer_qrcode_img"><img src="wa/vote/1502/assets/img/qrcode.png"></div>
		</div>
	</div>
