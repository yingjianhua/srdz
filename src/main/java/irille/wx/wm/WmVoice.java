...
public class WmVoice extends BeanInt<WmVoice> implements IExtName {
	private static final Log LOG = new Log(WmVoice.class);
	public static final Tb TB = new Tb(WmVoice.class, "语音消息").setAutoIncrement().addActIUDL()
			.addActOpt("sync", "同步").addActOpt("unsync", "取消同步").addActOpt("preview", "群发预览").addActOpt("mass", "群发"); 

	public enum T implements IEnumFld {// @formatter:off
		PKEY(TB.crtIntPkey()), // 主键
		NAME(SYS.NAME__40),
		VOICE_URL(SYS.STR__100, "语音"),
		MEDIA_ID(SYS.STR__100_NULL,"语音ID"),
  ...
  private String _voiceUrl;	// 语音  STR(100)
  private String _mediaId;	// 语音ID  STR(100)<null>
  ...
  public WmVoice init(){
    ...
    _voiceUrl=null;	// 语音  STR(100)
    _mediaId=null;	// 语音ID  STR(100)
