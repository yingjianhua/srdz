...
public class WaActTemplate extends BeanInt<WaActTemplate> implements IExtName{
	private static final Log LOG = new Log(WaActTemplate.class);
	public static final Tb TB = new Tb(WaActTemplate.class, "页面模板").setAutoIncrement().addActIUDL();
