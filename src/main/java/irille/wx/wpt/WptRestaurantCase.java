...
public class WptRestaurantCase extends BeanInt<WptRestaurantCase> {
	private static final Log LOG = new Log(WptRestaurantCase.class);
	public static final Tb TB = new Tb(WptRestaurantCase.class, "私人定制案例").setAutoIncrement().addActIUDL();
	...
	public enum T implements IEnumFld {// @formatter:off
		...
		// 索引
		public static final Index IDX_RESTAURANT = TB.addIndex("restaurant", false, T.RESTAURANT);
