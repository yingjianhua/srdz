...
public class WptCustomService extends BeanInt<WptCustomService> implements IExtName {
  ...
  //方法----------------------------------------------
  public static WptCustomService loadUniqueName(boolean lockFlag,String name) {
    return (WptCustomService)loadUnique(T.IDX_NAME,lockFlag,name);
  }
  public static WptCustomService chkUniqueName(boolean lockFlag,String name) {
    return (WptCustomService)chkUnique(T.IDX_NAME,lockFlag,name);
  }
