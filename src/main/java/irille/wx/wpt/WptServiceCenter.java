...
public class WptServiceCenter extends BeanInt<WptServiceCenter> {
	private static final Log LOG = new Log(WptServiceCenter.class);
	public static final Tb TB = new Tb(WptServiceCenter.class, "客服中心").setAutoLocal().addActList()
