...
public class WptRestaurantBanner extends BeanInt<WptRestaurantBanner> {
	private static final Log LOG = new Log(WptRestaurantBanner.class);
	public static final Tb TB = new Tb(WptRestaurantBanner.class, "餐厅顶图").setAutoIncrement().addActIUDL();
  ...
  private Short _rowVersion;	// 版本  SHORT
	...
	@Override
  public WptRestaurantBanner init(){
		super.init();
