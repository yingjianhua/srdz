...
public class WaxManBsn extends BeanInt<WaxManBsn> {
	private static final Log LOG = new Log(WaxManBsn.class);
	public static final Tb TB = new Tb(WaxManBsn.class, "拍摄商家").setAutoIncrement().addActIUDL();

	public enum T implements IEnumFld {// @formatter:off
		PKEY(TB.crtIntPkey()), // 主键
		MAN(WaxMan.fldOutKey().setName("男人帮")),
  ...
  private Integer _man;	// 男人帮 <表主键:WaxMan>  INT
  private Integer _bsn;	// 拍摄商家 <表主键:WpBsn>  INT
  private Integer _account;	// 公众帐号 <表主键:WxAccount>  INT
  private Short _rowVersion;	// 版本  SHORT

	@Override
  public WaxManBsn init(){
		super.init();
    _man=null;	// 男人帮 <表主键:WaxMan>  INT
  ...
  public WaxMan gtMan(){
    if(getMan()==null)
      return null;
    return (WaxMan)get(WaxMan.class,getMan());
  }
  public void stMan(WaxMan man){
    if(man==null)
      setMan(null);
    else
      setMan(man.getPkey());
