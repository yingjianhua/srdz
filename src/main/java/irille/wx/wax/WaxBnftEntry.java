...
public class WaxBnftEntry extends BeanInt<WaxBnftEntry> implements IExtName {
	private static final Log LOG = new Log(WaxBnftEntry.class);
	public static final Tb TB = new Tb(WaxBnftEntry.class, "福利报名").setAutoIncrement().addActList();
	...
	public enum T implements IEnumFld {// @formatter:off
		...
		// 索引
		public static final Index IDX_WX_USER_BNFT = TB.addIndex("wxUserBnft", true, T.WX_USER, T.BNFT);
  ...
  //方法----------------------------------------------
  public static WaxBnftEntry loadUniqueWxUserBnft(boolean lockFlag,Integer wxUser,Integer bnft) {
    return (WaxBnftEntry)loadUnique(T.IDX_WX_USER_BNFT,lockFlag,wxUser,bnft);
  }
  public static WaxBnftEntry chkUniqueWxUserBnft(boolean lockFlag,Integer wxUser,Integer bnft) {
    return (WaxBnftEntry)chkUnique(T.IDX_WX_USER_BNFT,lockFlag,wxUser,bnft);
  }
