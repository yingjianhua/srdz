...
public class WaxLadyPic extends BeanInt<WaxLadyPic> {
	private static final Log LOG = new Log(WaxLadyPic.class);
	public static final Tb TB = new Tb(WaxLadyPic.class, "图片").setAutoIncrement();

	public enum T implements IEnumFld {// @formatter:off
		PKEY(TB.crtIntPkey()), // 主键
		LADY(WaxLady.fldOutKey()),
