...
public class WaxMan extends BeanInt<WaxMan> implements IExtName {
	private static final Log LOG = new Log(WaxMan.class);
	public static final Tb TB = new Tb(WaxMan.class, "男人帮").setAutoIncrement().addActList();
  ...
  //方法----------------------------------------------
  public static WaxMan loadUniqueWxUserAccount(boolean lockFlag,Integer wxUser,Integer account) {
    return (WaxMan)loadUnique(T.IDX_WX_USER_ACCOUNT,lockFlag,wxUser,account);
  }
  public static WaxMan chkUniqueWxUserAccount(boolean lockFlag,Integer wxUser,Integer account) {
    return (WaxMan)chkUnique(T.IDX_WX_USER_ACCOUNT,lockFlag,wxUser,account);
  }
