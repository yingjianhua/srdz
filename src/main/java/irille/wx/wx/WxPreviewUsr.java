...
public class WxPreviewUsr extends BeanInt<WxPreviewUsr> {
  private static final Log LOG = new Log(WxPreviewUsr.class);
  public static final Tb TB = new Tb(WxPreviewUsr.class, "群发预览用户").setAutoLocal().addActList().addActIns().addActDel();
