 ...
 * @version 1.0
 */
public abstract class BeanBill<T extends BeanBill> 
		extends BeanForm<T> implements IBill{
	
	
//	public static final Tb TB = new Tb(BeanBill.class, "凭证", BeanForm.TB);
//	public static final Fld FLD_ACCOUNT_DATE = TB.crtDate("accountDate", "记账日期").setNull();
//	
//
//	// whx方法-----------------------------------------------------
