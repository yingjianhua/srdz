 ...
 * @version 1.0
 */
public class ValidTb extends Valid {
	private static final Log LOG = new Log(ValidTb.class);
	public static final ValidTb DEFAULT = new ValidTb();
	...
	public int compare(Object obj1, Object obj2) {
		throw LOG.err("tbCanNotComp", "表对象不可比较");
	}
}
