...
public class SysPerson extends BeanLong<SysPerson> {
public static final Tb TB = new Tb(SysPerson.class, "个人信息表", "个人").setAutoLocal();
...
//		(FLDS.),
		...
		HO_TEL(TB.get("hoTel")),	//家庭电话
		HO_ADDR(TB.get("hoAddr")),	//家庭地址
		HO_ZIP_CODE(TB.get("hoZipCode")),	//家庭邮编
...
//	}
  ...
  private String _hoTel;	// 家庭电话  STR(20)<null>
  private String _hoAddr;	// 家庭地址  STR(200)<null>
  private String _hoZipCode;	// 家庭邮编  STR(6)<null>
  ...
  public SysPerson init(){
    ...
    _hoTel=null;	// 家庭电话  STR(20)
    _hoAddr=null;	// 家庭地址  STR(200)
    _hoZipCode=null;	// 家庭邮编  STR(6)
  ...
  //组合对象的操作
  public CmbMsgHome gtHo(){
    CmbMsgHome b=new CmbMsgHome();
    	b.setTel(_hoTel);
    	b.setAddr(_hoAddr);
    	b.setZipCode(_hoZipCode);
    return b;
  }
  public void stHo(CmbMsgHome ho){
    _hoTel=ho.getTel();
    _hoAddr=ho.getAddr();
    _hoZipCode=ho.getZipCode();
  }
